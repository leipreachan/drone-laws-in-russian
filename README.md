...
Полёты и импорт дронов разрешены строго при наличии разрешения, без разрешения - [конфискация дрона в аэропорту](https://gisbarbados.gov.bb/blog/one-year-ban-on-importation-of-drones/). Бан датируется 2016 годом, но пока его продлевали три года подряд на следующий год.
...
* С 30го ноября 2019 года требуется обязательная регистрация всех пилотов дронов весом от 250г до 20кг по адресу <register-drones.caa.co.uk>. Сайт станет доступным 5го ноября. Регистрация платная, 9 фунтов в год
* С 30го ноября 2019 года требуется обязательное прохождение онлайн-теста для всех пилотов дронов весом от 250го до 20кг. Тестирование бесплатное и его требуется проходить раз в три года
...
Вкратце, во Франции запрещены полёты над Парижем и в пределах ряда зон, не обозначенных на картах DJI. В остальных местах летать можно. <http://www.developpement-durable.gouv.fr/quelle-place-drones-dans-ciel-francais>
...
* красные зоны - полёты запрещены
* розовые зоны - максимальная высота 30 метров
* оранжевые зоны - максимальная высота 50 метров
* тёмно-жёлтые зоны - максимальная высота 60 метров
* жёлтые зоны - максимальная высота 100 метров
* без указаний - максимальная высота 150 метров
...
Для ввоза и полётов требуется разрешение, в противном случае - конфискация дрона и штраф в 350 евро. Процесс получения разрешения описан в этой статье: https://blog.sitngo.me/opyt/kvadrokopter-v-chernogorii/ 
