...
**Представление** - официальное письмо в ОрВД, с которого начинается разрешение о полёте. На выходе получаем Местный режим и номер заявки. Номер заявки обычно такой же как у номера борта.
