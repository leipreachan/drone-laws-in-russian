...
## План
1. Посмотреть какой [ОрВД :grey_question:](#ОрВД) (Центр организации воздушного движения) ответственный в вашей зоне полёта
2. Позвонить в ОрВД, узнать на кого и куда писать [Представление о полёте :grey_question:](#Представление) (Заявка на получение разрешения)
...
6. Составить [План полёта :grey_question:](#ПланПолёта)
