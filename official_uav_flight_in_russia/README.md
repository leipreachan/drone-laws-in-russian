...
**<a name="ПланПолёта">План полёта, ПП</a>** - [AA_RF.kmz](AA_RF.kmz) - специально составленный, машиночитаемый документ, который содержит в себе все данные о полёте, пилоте, борте, координатах и высотах. А так же время старта и время лётной смены.

**<a name="АктуальныеПолетныеЗоны">Актуальные Полётные Зоны</a>** - действительно актуальный список полётных зон, автоматически обновляемый примерно каждые две минуты. Для просмотра вам понадобится [Google Earth](https://www.google.com/earth/) и работающий интернет
