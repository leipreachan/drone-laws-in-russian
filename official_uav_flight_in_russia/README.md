...
## План
1. Посмотреть какой [ОрВД :question:](#ОрВД) (Центр организации воздушного движения) ответственный в вашей зоне полёта
2. Позвонить в ОрВД, узнать на кого и куда писать [Представление о полёте :question:](#Представление) (Заявка на получение разрешения)
...
6. Составить [План полёта :question:](#ПланПолёта)
