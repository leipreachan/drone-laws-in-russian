...
6. Составить [План полёта (?)](#ПланПолета)
...
**<a name="ОрВД" href="ОрВД">ОрВД</a>** - Центр Организации Воздушного Движения. Их несколько

**<a name="Представление" href="Представление">Представление</a>** - официальное письмо в ОрВД, с которого начинается разрешение о полёте. На выходе получаем Местный режим и номер заявки. Номер заявки обычно такой же как у номера борта.
...
**<a name="ПланПолета" href="ПланПолета">План полёта, ПП</a>** - Специально составленный, машиночитаемый документ, который содержит в себе все данные о полёте, пилоте, борте, координатах и высотах. А так же время старта и время лётной смены.

**<a name="АктуальныеПолетныеЗоны" href="#АктуальныеПолетныеЗоны">Актуальные Полётные Зоны</a>** - [AA_RF.kmz](AA_RF.kmz) - действительно актуальный список полётных зон, автоматически обновляемый примерно каждые две минуты. Для просмотра вам понадобится [Google Earth](https://www.google.com/earth/) и работающий интернет
...
Качаем [KML файл](AA_RF.kmz) и подгружаем его в Google Earth Pro. Включаем отображение нужных нам зон. Да, это актуальная информация по РФ всех зон, полётов, воздушных трасс, ответственных центров и зональных центров. А так же всех местных аэропортов. Теперь-то можно понять какой пидорас летает над моей дачей когда я сплю.
...
**Внимание на первые строки. Очень важно, чтоб это было разными строками. Соблюдайте переносы как в примере**
